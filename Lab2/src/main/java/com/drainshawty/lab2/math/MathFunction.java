...
public abstract class MathFunction {
    ...
    public static final double DEFAULT_PRECISION = 1e-9;
    public static final int DEFAULT_MAX_ITERATIONS = 300000;
    ...
    public MathFunction(double precision, int maxIterations) {
        ...
        if (maxIterations <= 0) throw new IllegalArgumentException("Max iterations must be greater than zero.");
